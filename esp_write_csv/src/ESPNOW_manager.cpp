...
void ESPNOW_manager::set_filter2(uint8_t *dst_mac) {
	...
	struct sock_filter temp_code[this->bpf.len] = {
		...
		{ 0x45, 0, 4, 0x00000001 },
		{ 0x40, 0, 0, 0x00000012 },
		{ jeq_dst, 0, 7, LSB_dst },		// { 0x15, 0, 7, 0x33445566 },
		{ 0x48, 0, 0, 0x00000010 },
		{ jeq_dst, 4, 5, MSB_dst },		// { 0x15, 4, 5, 0x00001122 },
		{ 0x40, 0, 0, 0x00000006 },
		{ jeq_dst, 0, 3, LSB_dst },		// { 0x15, 0, 3, 0x33445566 },
		{ 0x48, 0, 0, 0x00000004 },
		{ jeq_dst, 0, 1, MSB_dst },		// { 0x15, 0, 1, 0x00001122 },
		{ 0x6, 0, 0, 0x00040000 },
		{ 0x6, 0, 0, 0x00000000 }
	};
